...
sens_price <- data.frame(
    price = seq(10, 30),
    predicted_prob = c(0.995025045, 0.991785700, 0.986465810, 0.977777755, 
                       0.963717671, 0.941295823, 0.906363958, 0.853872777,
                       0.779126552, 0.680454783, 0.562457464, 0.436942681,
                       0.319015379, 0.220454212, 0.145823308, 0.093429352,
                       0.058569613, 0.036197184, 0.022169337, 0.013501681,
                       0.008194463),
    predicted_prob_lower = c(0.983924548, 0.975490322, 0.962528687, 0.943222132,
                             0.914102765, 0.872021326, 0.813390324, 0.734363280,
                             0.634852510, 0.520036928, 0.402517843, 0.291964212,
                             0.198626044, 0.128872911, 0.080236739, 0.048405387,
                             0.028457843, 0.016443313, 0.009422056, 0.005352835,
                             0.003031963),
    predicted_prob_upper = c(0.99843671, 0.99722977, 0.99508459, 0.99127695,
                             0.98467132, 0.97330460, 0.95387431, 0.92267714,
                             0.87377070, 0.80158077, 0.70330904, 0.58545490,
                             0.45985147, 0.34349963, 0.24550091, 0.16916026,
                             0.11393586, 0.07565677, 0.04947257, 0.03247048,
                             0.02132043)
)
...
kable(
    sens_price,
    digits = 3,
    caption = "Price Sensitivity Analysis",
    col.names = c("Price ($)", "Market Share", "Lower 95% CI", "Upper 95% CI"),
    align = c("r", "r", "r", "r")
)
...
sens_atts <- data.frame(
    attribute = c("other", "price", "price", "range", "range", "capacity", "capacity"),
    case = c("base", "high", "low", "high", "low", "high", "low"),
    value = c(NA, 16.0, 24.0, 2.4, 1.6, 1.6, 2.4),
    predicted_prob = c(0.0934293521, 0.9063639584, 0.1458233075, 0.2959048803,
                       0.1584150398, 0.0003534582, 0.0013421835)
)
...
sens_atts %>%
    ...
    kable(
        digits = 4,
        caption = "Attribute Sensitivity Analysis",
        col.names = c("Attribute", "Case", "Value", "Market Share"),
        align = c("l", "l", "r", "r")
    )
...
![Market Share](images/tornado.jpeg)
