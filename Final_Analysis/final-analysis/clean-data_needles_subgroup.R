...
# Import raw data
data_raw <- read_csv(here("data", "FinalSurveyV2_2025-12-03.csv"))

# Filter out those afraid / unafraid of needles as needed for subgroup analysis
data_raw <- data_raw %>% 
    filter(needles == 'blue')
...
write_csv(choice_data, here("data", "choice_data_afraid.csv"))
