...
::: {.callout-note}
There are two versions of the conjoint survey: "button" and "table". This is the "**button**" version. In this version, the conjoint options are shown in buttons.
:::
...
## Type / Location
We will show several **form factors**:
- **Bracelet** or **Ring** (wearables)
- **Card** (wallet alternative)
- **Implant** (subdermal location such as **hand**, **wrist**, or **finger**)
